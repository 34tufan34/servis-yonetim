(function () {
  ...
  function loadCommandLayoutFix() {
    if (window.__SYS_V44854_COMMAND_LAYOUT_LOADER__) return;
    window.__SYS_V44854_COMMAND_LAYOUT_LOADER__ = true;

    const script = document.createElement("script");
    script.src = "./scripts/command-layout-v4_48_23.js?v=4.48.54";
    script.defer = true;
    script.onerror = () => console.error("SYS v4.48.54 komuta paneli düzeltmesi yüklenemedi.");
    document.head.appendChild(script);

    const previewScript = document.createElement("script");
    previewScript.src = "./scripts/command-preview-v4_48_49.js?v=4.48.54";
    previewScript.defer = true;
    previewScript.onerror = () => console.error("SYS v4.48.54 komuta paneli yüklenemedi.");
    document.head.appendChild(previewScript);

    const experienceScript = document.createElement("script");
    experienceScript.src = "./scripts/sys-experience-v4_48_49.js?v=4.48.54";
    experienceScript.defer = true;
    experienceScript.onerror = () => console.error("SYS v4.48.54 kullanım deneyimi yüklenemedi.");
    experienceScript.addEventListener("load", () => {
      const fullHeightScript = document.createElement("script");
      fullHeightScript.src = "./scripts/command-full-height-v4_48_49.js?v=4.48.54-komuta-katalog-1";
      fullHeightScript.defer = true;
      fullHeightScript.onerror = () => console.error("SYS v4.48.54 tam boy komuta kartları yüklenemedi.");
