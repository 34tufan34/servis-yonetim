(function () {
  ...
  function install() { installStyles(); buildPriceOffersPanel(); installContactImport(); installCurrentLocationAddress(); installAddressBulkDelete(); installDiscountFuelSettings(); installKmOfferRecords(); showFirstSetup(); }
