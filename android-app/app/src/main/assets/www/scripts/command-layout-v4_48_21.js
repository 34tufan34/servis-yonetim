(function () {
  ...
  if (window.__SYS_V44821_COMMAND_LAYOUT__) return;
  window.__SYS_V44821_COMMAND_LAYOUT__ = true;

  const STYLE_ID = "sys-v44821-command-layout";
  ...
  function clearOldInlineSizing() {
    ...
    [
      ...
      screen.querySelector(".command-left"),
      screen.querySelector(".command-right")
    ...
    screen.dataset.sysLayoutVersion = "4.48.21";
  }
