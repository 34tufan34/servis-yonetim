(function () {
  ...
  if (window.__SYS_COMMAND_PANEL_V44840__) return;
  window.__SYS_COMMAND_PANEL_V44840__ = true;
      ...
      <div class="command-preview-shell">
        ...
        <div class="command-preview-body">
          ...
          <aside class="command-preview-rail">
            ...
            <div class="command-preview-fuel"><small>MAZOT FİYATLARI</small><div class="preview-fuel-brand-row"><span class="preview-fuel-logo shell">SHELL</span><strong id="previewShellPrice">—</strong></div><div class="preview-fuel-brand-row"><span class="preview-fuel-logo opet">OPET</span><strong id="previewOpetPrice">—</strong></div></div>
