(function () {
  ...
  if (window.__SYS_COMMAND_PREVIEW_V44837__) return;
  window.__SYS_COMMAND_PREVIEW_V44837__ = true;
    ...
    screen.innerHTML = `
      <div class="command-preview-shell">
        <header class="command-preview-hero">
          ...
          <div class="command-preview-topline"><span>SYS · OPERASYON MERKEZİ</span><b>ALTERNATİF TASARIM</b></div>
