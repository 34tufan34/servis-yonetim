(function () {
  "use strict";
  if (window.__SYS_EXPERIENCE_V44842__) return;
  window.__SYS_EXPERIENCE_V44842__ = true;

  const $ = (selector, root = document) => root.querySelector(selector);

  function installStyles() {
    const style = document.createElement("style");
    style.id = "sys-experience-v44842";
    style.textContent = `
  ...
  function install() { installStyles(); buildAiHub(); installContactImport(); installAddressBulkDelete(); installDiscountFuelSettings(); showFirstSetup(); }
