(function () {
    ...
    screen.innerHTML = `
      <div class="command-preview-shell">
        <header class="command-preview-hero">
          ...
          <div class="command-preview-live"><strong id="previewLiveCount">0</strong><span>CANLI<br>SERVİS</span></div>
        </header>
  ...
  function syncPanel() {
    ...
    const personnelLive = $("#commandPersonnelCard")?.classList.contains("is-live");
