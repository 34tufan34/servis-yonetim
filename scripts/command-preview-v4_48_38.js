(function () {
  ...
  if (window.__SYS_COMMAND_PANEL_V44838__) return;
  window.__SYS_COMMAND_PANEL_V44838__ = true;
      ...
      <div class="command-preview-shell">
        ...
        <div class="command-preview-body">
          ...
          <aside class="command-preview-rail">
            ...
            <div class="command-preview-fuel"><small>MAZOT FİYATLARI</small><strong><span id="previewShellPrice">—</span> · <span id="previewOpetPrice">—</span></strong><span>Shell · Opet</span></div>
            <div class="command-preview-fuel-difference"><small>MAZOT FARKI UYARISI</small><strong id="previewFuelDifferenceTitle">Uyarı yok</strong><span id="previewFuelDifferenceText">Sözleşmeler güncel.</span></div>
          </aside>
        </div>
      </div>`;
  ...
  function install() {
    ...
    if (classicNav?.classList.contains("active") || classicScreen?.classList.contains("active")) $(".command-preview-nav")?.click();
    syncPanel();
