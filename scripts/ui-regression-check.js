...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_35.js"), "Alternatif komuta paneli yükleyicisi eksik."],
  [read("scripts/command-preview-v4_48_35.js").includes("screen-command-preview") && read("scripts/command-preview-v4_48_35.js").includes("previewClock"), "Alternatif komuta paneli geliştirmeleri eksik."],
  [read("scripts/command-preview-v4_48_35.js").includes("command-personnel-mark") && read("scripts/command-preview-v4_48_35.js").includes("command-school-mark"), "Yeni komuta hızlı yolcu işlemleri eksik."],
  [read("scripts/command-preview-v4_48_35.js").includes("Personel Toplanıyor") && read("scripts/command-preview-v4_48_35.js").includes("Personel Dağıtılıyor") && read("scripts/command-preview-v4_48_35.js").includes("SERVİS HAREKET ETTİ"), "Akşam personel servisi aşamaları yeni komuta panelinde eksik."],
