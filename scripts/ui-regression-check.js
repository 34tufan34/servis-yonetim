...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_47.js") && appVersion.includes("sys-experience-v4_48_47.js"), "Yeni deneyim yükleyicileri eksik."],
  [read("scripts/sys-experience-v4_48_47.js").includes("buildPriceOffersPanel") && read("scripts/sys-experience-v4_48_47.js").includes("#priceOffersHost") && read("scripts/sys-experience-v4_48_47.js").includes('insertBefore(navButton, financeNav)'), "Fiyat Teklifleri bağımsız menü bölümü eksik."],
  [read("scripts/command-preview-v4_48_47.js").includes('$(\".command-preview-nav\")?.click()'), "Uygulama başlangıcında Komuta Paneli açılmıyor."],
  ...
  [read("scripts/sys-experience-v4_48_47.js").includes("grid-template-columns:22px 38px") && read("scripts/sys-experience-v4_48_47.js").includes("flex-wrap:nowrap!important"), "Adres Defteri kompakt satır düzeni eksik."],
  [read("scripts/sys-experience-v4_48_47.js").includes("installCurrentLocationAddress") && read("scripts/sys-experience-v4_48_47.js").includes("navigator.geolocation.getCurrentPosition") && read("scripts/sys-experience-v4_48_47.js").includes("Bulunduğum Konumu Ekle"), "Adres Defteri mevcut konum kaydı eksik."],
  [read("scripts/sys-experience-v4_48_43.js").includes("installKmOfferRecords") && read("scripts/sys-experience-v4_48_43.js").includes("kmOfferCompany") && read("scripts/sys-experience-v4_48_43.js").includes("kmOfferUnitPrice"), "Kalıcı KM teklif kayıt modülü eksik."],
  [read("scripts/sys-experience-v4_48_43.js").includes("price / totalKm") && read("scripts/sys-experience-v4_48_43.js").includes("kmOfferRecords"), "KM fiyatı otomatik hesaplama veya kalıcı kayıt eksik."],
