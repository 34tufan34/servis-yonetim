...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_36.js") && appVersion.includes("sys-experience-v4_48_36.js"), "Yeni deneyim yükleyicileri eksik."],
  [read("scripts/command-preview-v4_48_36.js").includes("screen-command-preview") && read("scripts/command-preview-v4_48_36.js").includes("previewClock"), "Alternatif komuta paneli geliştirmeleri eksik."],
  [read("scripts/command-preview-v4_48_36.js").includes("command-personnel-mark") && read("scripts/command-preview-v4_48_36.js").includes("command-school-mark"), "Yeni komuta hızlı yolcu işlemleri eksik."],
  [read("scripts/command-preview-v4_48_36.js").includes("Personel Toplanıyor") && read("scripts/command-preview-v4_48_36.js").includes("Personel Dağıtılıyor") && read("scripts/command-preview-v4_48_36.js").includes("SERVİS HAREKET ETTİ"), "Akşam personel servisi aşamaları yeni komuta panelinde eksik."],
  [read("scripts/command-preview-v4_48_36.js").includes("previewPersonnelPrimary") && read("scripts/command-preview-v4_48_36.js").includes('personnelActive ? "Servisi Bitir"'), "Aktif servis ana düğmesi güncellenmiyor."],
  ...
  [read("scripts/sys-experience-v4_48_36.js").includes("screen-sys-ai") && read("scripts/sys-experience-v4_48_36.js").includes("driver-actions"), "SYS AI merkezi veya şoför tasarımı eksik."],
