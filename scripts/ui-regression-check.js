...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_38.js") && appVersion.includes("sys-experience-v4_48_38.js"), "Yeni deneyim yükleyicileri eksik."],
  [read("scripts/command-preview-v4_48_38.js").includes("screen-command-preview") && read("scripts/command-preview-v4_48_38.js").includes("previewClock"), "Komuta paneli geliştirmeleri eksik."],
  [read("scripts/command-preview-v4_48_38.js").includes("command-personnel-mark") && read("scripts/command-preview-v4_48_38.js").includes("command-school-mark"), "Yeni komuta hızlı yolcu işlemleri eksik."],
  [read("scripts/command-preview-v4_48_38.js").includes("Personel Toplanıyor") && read("scripts/command-preview-v4_48_38.js").includes("Personel Dağıtılıyor") && read("scripts/command-preview-v4_48_38.js").includes("SERVİS HAREKET ETTİ"), "Akşam personel servisi aşamaları yeni komuta panelinde eksik."],
  [read("scripts/command-preview-v4_48_38.js").includes("previewPersonnelPrimary") && read("scripts/command-preview-v4_48_38.js").includes('personnelActive ? "Servisi Bitir"'), "Aktif servis ana düğmesi güncellenmiyor."],
  ...
  [read("scripts/sys-experience-v4_48_38.js").includes("Personel Servisi Zekâsı") && read("scripts/sys-experience-v4_48_38.js").includes("collectAiPanels"), "Sistem geneli SYS AI merkezi eksik."],
  [read("scripts/sys-experience-v4_48_38.js").includes("grid-template-columns:58px") && read("scripts/sys-experience-v4_48_38.js").includes("driver-finish-btn.ready:not"), "Şoför adı/adres yerleşimi veya bitir düğmesi düzeltmesi eksik."],
  [read("scripts/sys-experience-v4_48_38.js").includes("navigator.contacts") && read("scripts/sys-experience-v4_48_38.js").includes("contactImportFile"), "Telefon rehberi içe aktarma eksik."],
  [html.includes("SYS_FIRST_SETUP_PENDING_V1") && read("scripts/sys-experience-v4_48_38.js").includes("showFirstSetup"), "Tam sıfırlama sonrası ilk kurulum eksik."],
  [read("scripts/command-preview-v4_48_38.js").includes("previewFuelDifferenceTitle") && read("scripts/command-preview-v4_48_38.js").includes("previewShellPrice"), "Komuta paneli mazot özetleri eksik."],
  [html.includes("selectAllAddressesBtn") && read("scripts/sys-experience-v4_48_38.js").includes("installAddressBulkDelete"), "Adres Defteri toplu silme eksik."],
  [!read("scripts/command-preview-v4_48_38.js").includes("ÖN İZLEME") && read("scripts/sys-experience-v4_48_38.js").includes("command-panel-backend"), "Yeni komuta paneli ana panel olarak etkin değil."],
