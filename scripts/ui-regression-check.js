...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_44.js") && appVersion.includes("sys-experience-v4_48_44.js"), "Yeni deneyim yükleyicileri eksik."],
  [read("scripts/sys-experience-v4_48_44.js").includes("#kmOfferRecordsCard{grid-column:1/-1!important") && read("scripts/sys-experience-v4_48_44.js").includes("justify-self:stretch"), "KM Teklif kartı tam genişlik düzeltmesi eksik."],
  [read("scripts/sys-experience-v4_48_44.js").includes("installCurrentLocationAddress") && read("scripts/sys-experience-v4_48_44.js").includes("navigator.geolocation.getCurrentPosition") && read("scripts/sys-experience-v4_48_44.js").includes("Bulunduğum Konumu Ekle"), "Adres Defteri mevcut konum kaydı eksik."],
