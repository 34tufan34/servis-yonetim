...
const checks = [
  ...
  [appVersion.includes("command-preview-v4_48_45.js") && appVersion.includes("sys-experience-v4_48_45.js"), "Yeni deneyim yükleyicileri eksik."],
  [read("scripts/sys-experience-v4_48_45.js").includes("#commandKmOfferHost") && read("scripts/command-preview-v4_48_45.js").includes("KM Fiyat Teklifleri"), "KM Teklifleri Komuta Paneli sekmesi eksik."],
  [read("scripts/command-preview-v4_48_45.js").includes('$(\".command-preview-nav\")?.click()'), "Uygulama başlangıcında Komuta Paneli açılmıyor."],
  ...
  [read("scripts/sys-experience-v4_48_45.js").includes("grid-template-columns:22px 38px") && read("scripts/sys-experience-v4_48_45.js").includes("flex-wrap:nowrap!important"), "Adres Defteri kompakt satır düzeni eksik."],
  [read("scripts/sys-experience-v4_48_45.js").includes("installCurrentLocationAddress") && read("scripts/sys-experience-v4_48_45.js").includes("navigator.geolocation.getCurrentPosition") && read("scripts/sys-experience-v4_48_45.js").includes("Bulunduğum Konumu Ekle"), "Adres Defteri mevcut konum kaydı eksik."],
